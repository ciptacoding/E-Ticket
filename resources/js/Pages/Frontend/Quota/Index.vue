                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            >
                                <div class="grid gap-6 mb-2 grid-cols-1">
                                    <div>
                                        <h1
                                            class="text-center text-2xl font-bold mb-2 lg:mb-4 text-[#DF6951]"
                                        >
                                            Quota And Weather
                                        </h1>
                                        <h1 class="text-sm text-gray-900">
                                            Note: Please confirm your check-in
                                            date and make sure it's still
                                            available before ordering tickets
                                            online.
                                        </h1>
                                    </div>
                                    <div>
                            ...
                            <div class="mx-8 my-5 flex flex-col items-center">
                                <div class="flex items-center w-full xl:w-2/3">
                                    <div
